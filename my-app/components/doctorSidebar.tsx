...
const menuItems = [
  { name: 'Search Patient', icon: MagnifyingGlassIcon, href: '/doctor/search-patient' },
  { name: 'My Patients', icon: UsersIcon, href: '/doctor/my-patients' },
  { name: 'My Profile', icon: UserIcon, href: '/doctor/profile' },
];
